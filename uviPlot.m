function [dataset] = uviPlot(dataset,arrangement,normalize)
% uviPlot(dataset,arrangement) plots UV-vis-NIR data 
...
% cm^-1   Absorption  cm^-1   Absorption
% *******************
